...
const meta = {
  ...
  // (dd.file.ve speichert die interne Version der Daten; die ist nach
  ...
  oeffnen () {
    ...
    // Fenster füllen
    document.getElementById("meta-dc").textContent = helfer.datumFormat(dd.file.dc);
    const dm = document.getElementById("meta-dm");
    if (dd.file.dm) {
      dm.textContent = helfer.datumFormat(dd.file.dm);
    ...
    document.getElementById("meta-re").textContent = dd.file.re;
  },
};
