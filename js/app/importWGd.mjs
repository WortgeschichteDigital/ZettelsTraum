...
const importWGd = {
  ...
  async transformXML (xml) {
    ...
    // prepare XSLT
    const xslt = sharedXml.parseXML(importWGd.transformXSL, "application/xml");
    const processor = new XSLTProcessor();
    processor.importStylesheet(xslt);

    // transform XML
    const xmlOri = sharedXml.parseXML(xml);
