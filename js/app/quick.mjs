...
const quick = {
  ...
  icons: {
    ...
    "app-beenden": {
      title: "App > Beenden",
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + Q`,
      img: "ausgang.svg",
    },
    "kartei-erstellen": {
      title: "Kartei > Erstellen",
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + E`,
      img: "dokument-plus.svg",
    },
    "kartei-oeffnen": {
      title: "Kartei > Öffnen",
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + O`,
      img: "oeffnen.svg",
    },
    "kartei-speichern": {
      title: "Kartei > Speichern",
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + S`,
      img: "speichern.svg",
    },
    "kartei-speichern-unter": {
      title: "Kartei > Speichern unter",
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + Umsch + S`,
      img: "speichern-unter.svg",
    },
    "kartei-schliessen": {
      title: "Kartei > Schließen",
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + W`,
      img: "x-dick.svg",
    },
    "kartei-lemmata": {
    ...
    "kartei-bedeutungen": {
      ...
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + B`,
      img: "geruest.svg",
    },
    "kartei-bedeutungen-wechseln": {
      title: "Kartei > Bedeutungsgerüst wechseln",
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + ${sharedTastatur.shortcutsTextAktuell("Alt")} + B`,
    ...
    "kartei-suche": {
      title: "Kartei > Suche",
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + F`,
      img: "lupe.svg",
    },
    "redaktion-metadaten": {
    ...
    "belege-hinzufuegen": {
      ...
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + N`,
      img: "dokument-plus.svg",
    },
    "belege-auflisten": {
      title: "Belege > Auflisten",
      short: `${sharedTastatur.shortcutsTextAktuell("Strg")} + L`,
    ...
    a.addEventListener("click", function (evt) {
      ...
      switch (befehl) {
        case "app-neues-fenster":
          bridge.ipc.invoke("fenster-oeffnen");
          return;
        ...
        case "redaktion-literatur":
          ...
          return;
        case "hilfe-handbuch":
          bridge.ipc.invoke("hilfe-handbuch", "");
          return;
      }
  ...
  accessRoles (a) {
    a.addEventListener("click", function (evt) {
      ...
      bridge.ipc.invoke("quick-roles", befehl);
    });
  },
