...
const bedeutungen = {
  ...
  aufbauen () {
    // falls das aktuelle Bedeutungsgerüst gelöscht wurde => aktuelles Gerüst des Hauptfensters auswählen
    if (bedeutungen.geruest && !bedeutungen.data.bd.gr[bedeutungen.geruest]) {
